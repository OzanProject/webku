...
<div class="p-md md:p-lg lg:p-xl mt-16 max-w-container-max mx-auto w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-md mb-lg">
        <div>
            ...
            <h2 class="text-headline-md font-headline-md font-bold text-on-surface">Tambah Produk</h2>
        </div>
    ...
    <div class="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-sm overflow-hidden">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-md md:p-lg">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-xl">
                ...
                <div class="lg:col-span-2 space-y-lg">
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="Contoh: Website Company Profile" class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-lg">
                        ...
                        <div>
                            ...
                            <input type="text" id="version" name="version" value="{{ old('version', '1.0.0') }}" placeholder="Contoh: 1.0.0" class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors">
                        </div>
                        
                        <!-- Release Date -->
                        <div>
                            <label for="release_date" class="block text-label-md font-label-md text-on-surface mb-xs">Tanggal Rilis (Opsional)</label>
                            <input type="date" id="release_date" name="release_date" value="{{ old('release_date', date('Y-m-d')) }}" class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price') }}" min="0" placeholder="0" class="w-full pl-xl pr-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" id="demo_link" name="demo_link" value="{{ old('demo_link') }}" placeholder="https://..." class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" required rows="3" placeholder="Deskripsi ringkas yang muncul di kartu produk..." class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors resize-y">{{ old('description') }}</textarea>
                    </div>

                    <!-- Content (Long) -->
                    <div>
                        <label for="content" class="block text-label-md font-label-md text-on-surface mb-xs">Konten Lengkap</label>
                        <textarea id="content" name="content" rows="10" placeholder="Tulis deskripsi lengkap, spesifikasi, atau studi kasus di sini..." class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors resize-y">{{ old('content') }}</textarea>
                    </div>
                ...
                <div class="space-y-lg">
                    ...
                    <div class="bg-surface-container-low p-md rounded-lg border border-outline-variant/50">
                        ...
                        <div class="w-full relative">
                            ...
                            <div id="image-preview-container" class="w-full h-48 bg-surface border-2 border-dashed border-outline-variant rounded-lg flex flex-col items-center justify-center text-on-surface-variant overflow-hidden relative">
                                <span class="material-symbols-outlined text-[48px] mb-2">add_photo_alternate</span>
                                <span class="text-label-sm">Klik atau drop gambar ke sini</span>
                                <span class="text-xs opacity-70 mt-1">JPG, PNG, WEBP (Max 2MB)</span>
