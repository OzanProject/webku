...
<div class="p-md md:p-lg lg:p-xl mt-16 max-w-container-max mx-auto w-full">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-md mb-lg">
        <div>
            ...
            <h2 class="text-headline-md font-headline-md font-bold text-on-surface">Tambah Layanan</h2>
        </div>
    ...
    <div class="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-sm overflow-hidden max-w-4xl">
        <form action="{{ route('admin.services.store') }}" method="POST" class="p-md md:p-lg">
            @csrf
            ...
            <div class="space-y-lg">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="Contoh: Web Development" class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-lg">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="material-symbols-outlined absolute left-sm top-1/2 -translate-y-1/2 text-on-surface-variant bg-surface-container-highest p-1 rounded" id="icon-preview">code</span>
                            <input type="text" id="icon" name="icon" value="{{ old('icon', 'code') }}" required placeholder="Contoh: web, design_services" class="w-full pl-12 pr-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors" onkeyup="document.getElementById('icon-preview').innerText = this.value || 'code'">
                        </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" required rows="4" placeholder="Penjelasan singkat mengenai layanan yang ditawarkan..." class="w-full px-md py-sm rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary bg-surface text-body-md outline-none transition-colors resize-y">{{ old('description') }}</textarea>
                </div>
