...
<div class="p-md md:p-lg lg:p-xl mt-16 max-w-container-max mx-auto w-full">
    ...
    <div class="flex items-center gap-sm mb-lg">
        ...
        <div>
            <h2 class="text-headline-md font-headline-md font-bold text-on-surface">Buat Pesanan Baru</h2>
            <p class="text-body-md font-body-md text-on-surface-variant">Input pesanan secara manual dari klien.</p>
        </div>
    </div>

    <form action="{{ route('admin.orders.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-lg">
        @csrf
        ...
        <div class="lg:col-span-2 flex flex-col gap-lg">
            ...
            <div class="bg-surface border border-outline-variant rounded-2xl p-lg shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                    <div>
                        ...
                        <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name') }}" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary px-md py-sm @error('customer_name') border-error @enderror" required placeholder="Contoh: Budi Santoso">
                    ...
                    <div>
                        ...
                        <input type="text" name="customer_phone" id="customer_phone" value="{{ old('customer_phone') }}" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary px-md py-sm @error('customer_phone') border-error @enderror" required placeholder="Contoh: 08123456789">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" name="customer_email" id="customer_email" value="{{ old('customer_email') }}" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary px-md py-sm @error('customer_email') border-error @enderror" placeholder="Contoh: budi@gmail.com">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                    <div>
                        ...
                        <select name="order_type" id="order_type" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary px-md py-sm @error('order_type') border-error @enderror" required>
                            <option value="Produk" {{ old('order_type') == 'Produk' ? 'selected' : '' }}>Produk / Aplikasi</option>
                            <option value="Layanan" {{ old('order_type') == 'Layanan' ? 'selected' : '' }}>Layanan Jasa</option>
                            <option value="Lainnya" {{ old('order_type') == 'Lainnya' ? 'selected' : '' }}>Lainnya (Custom)</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="item_name" id="item_name" value="{{ old('item_name') }}" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary px-md py-sm @error('item_name') border-error @enderror" required placeholder="Contoh: Web Company Profile">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="total_price" id="total_price" value="{{ old('total_price') }}" min="0" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary pl-12 pr-md py-sm @error('total_price') border-error @enderror" placeholder="0">
                        </div>
            ...
            <div class="bg-surface border border-outline-variant rounded-2xl p-lg shadow-sm">
                ...
                <textarea name="notes" id="notes" rows="4" class="w-full border-outline-variant rounded-lg text-body-md bg-surface focus:ring-primary focus:border-primary px-md py-sm" placeholder="Masukkan catatan tambahan dari klien (jika ada)...">{{ old('notes') }}</textarea>
            </div>
            ...
            <div class="bg-surface border border-outline-variant rounded-2xl p-lg shadow-sm">
                ...
                <div class="space-y-sm">
                    <label class="flex items-center gap-sm cursor-pointer p-sm hover:bg-surface-container-lowest rounded-lg transition-colors border border-outline-variant/50">
                        <input type="radio" name="status" value="Pending" class="text-[#d97706] focus:ring-[#d97706] w-5 h-5" {{ old('status', 'Pending') == 'Pending' ? 'checked' : '' }}>
                    ...
                    <label class="flex items-center gap-sm cursor-pointer p-sm hover:bg-surface-container-lowest rounded-lg transition-colors border border-outline-variant/50">
                        <input type="radio" name="status" value="Diproses" class="text-[#2563eb] focus:ring-[#2563eb] w-5 h-5" {{ old('status') == 'Diproses' ? 'checked' : '' }}>
                        <div class="flex items-center gap-2">
                    ...
                    <label class="flex items-center gap-sm cursor-pointer p-sm hover:bg-surface-container-lowest rounded-lg transition-colors border border-outline-variant/50">
                        <input type="radio" name="status" value="Selesai" class="text-[#047857] focus:ring-[#047857] w-5 h-5" {{ old('status') == 'Selesai' ? 'checked' : '' }}>
                        <div class="flex items-center gap-2">
